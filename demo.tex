...
\begin{minipage}[t]{0.27\textwidth} % 27% of the page width for the second row of icons
    ...
    \icon{Envelope}{11}{\href{mailto:ekrami.devops@gmail.com}{ekrami.devopsemail@example.com}}\\
    \icon{Github}{11}{\href{https://github.com/mjekrami}{github.com/mjekrami}}\\
    \icon{LinkedinSquare}{11}{\href{https://www.linkedin.com}{/}}\\
...
\begin{entrylist}
    ...
    \end{itemize}
    {\vspace{2pt}}
    \texttt{Elasticsearch} \slashsep \texttt{Argocd} \slashsep \texttt{SQL} \slashsep \texttt{Java} \slashsep \texttt{Ansible}}
\end{entrylist}
% Driverly
\begin{center}
